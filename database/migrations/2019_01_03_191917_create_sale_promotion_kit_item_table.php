...
class CreateSalePromotionKitItemTable extends Migration {
	...
	public function up()
	{
		Schema::create('sale_promotion_kit_item', function(Blueprint $table)
		{
			...
			$table->primary(['store_key','pos_number','ticket_number','fiscal_date','promotion_key','plu_kit','plu_id'], 'index_sale_promotion_kit_item');
		});
	}
	...
	{
		Schema::drop('sale_promotion_kit_item');
	}
